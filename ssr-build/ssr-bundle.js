...
function App() {
  ...
  }), h("p", null, "I lead a team of four skilled frontend engineers, tasked with the following key responsibilities:"), h(_components_chip_ChipComponent__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    titles: ['ReactJS', 'TypeScript', 'Cypress', 'Storybook']
  }), h("ul", null, h("li", null, "Developing and maintaining an open-source, highly accessible, component library in alignment with UX-designers."), h("li", null, "Building scalable user interfaces using ReactJS, TypeScript in a micro-frontend architecture."), h("li", null, "Trying out new ideas by developing proof-of-concepts, like UI customisation strategy of SaaS products or event-driven architecture of micro-frontends."), h("li", null, "Owning, developing and maintaining production-running micro-frontend containers."), h("li", null, "Writing various types of tests, including unit, component, end-to-end, and visual tests.")), h("p", null, "As a team leader, I also do the following:"), h("ul", null, h("li", null, "Plan and refine our work processes and tasks."), h("li", null, "Come up with new solutions."), h("li", null, "Promote a strong engineering culture within the team."), h("li", null, "Handle tasks like conducting job interviews, 1-on-1s, and annual performance reviews.")), h(_components_timeline_TimelineComponent__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
